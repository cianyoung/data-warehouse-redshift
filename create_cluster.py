...
main(args):
    ...
    if args.delete:
        ...
        """ Poll Redshift cluster after creation to check availability """
        timestep = 15
        ...
        """ Open TCP connection upon successful cluster execution """
        if cluster:
...
if __name__ == '__main':
    ...
    # add arguments
    # optional argument, name of attribute: delete, default (not passed set to false), store True if encountered
    parser.add_argument('--delete', dest='delete', default=False, action='store_true')
    """ Parse the command-line arguments and store them in the arg variable """
